          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Vinicius Barbosa</strong>
                <span className="text-gray-200 text-sm block">CTO @Innercoding</span>
              </div>
            </div>
          </div>
